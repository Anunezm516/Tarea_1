...
def Insertar(rango):
    for i in range(int(rango)):
        ...
        if codigo.isdigit() and grupo.isdigit() and soloLetra(descripcion) and soloLetra(naturaleza) and estado.isdigit():
...
def Modificar():
    ...
    if id.isdigit() and codigo.isdigit() and grupo.isdigit() and soloLetra(descripcion) and soloLetra(naturaleza) and estado.isdigit():
